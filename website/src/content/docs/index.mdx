---
title: Stratum
description: Universal Tenant Context Engine — hierarchical multi-tenancy for any stack.
template: splash
hero:
  title: Universal Tenant Context Engine
  tagline: Hierarchical multi-tenancy for any stack. Tree-structured tenants, config inheritance, permission delegation, and three isolation strategies — all backed by PostgreSQL.
  actions:
    - text: Get Started
