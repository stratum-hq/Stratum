...
The Vite dev server proxies API requests to both backends.

## Demo API

A minimal Express server with a single endpoint:
...
3. Queries `security_events` (RLS filters automatically)
4. Resets tenant context on connection release
