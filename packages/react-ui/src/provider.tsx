...
import type { TenantNode, ResolvedTenantContext, ResolvedConfig, ResolvedPermission } from "@stratum-hq/core";
...
export function StratumProvider({
  ...
  const [tenantContext, setTenantContext] = useState<ResolvedTenantContext | null>(null);
